...
- Webchat widget repoointé onrender(mort)→aevia-inbox.vercel.app · `0ffd23c`
...
- **Hub URL faux dans mémoire** : j'avais mémorisé `valentin-milliand.vercel.app` comme le hub — c'est le mode PORTFOLIO du même repo. Hub = `aevia.vercel.app`. Correction : MEMORY.md mis à jour.
